...
| :---: | :--- |
| <img src="figs/dialfill_generate.png" width="500px" alt="DialFill Architecture"> | **DialFill: Dialogue Filling for Knowledge-Grounded Dialogue**<br><br>• **IEEE Access, 2025**<br>• Reframes knowledge-grounded dialogue as a **Dialogue Filling** task instead of direct generation.<br>• Ensures that selected knowledge appears in the final response while keeping the wording natural.<br>• **Benchmarks:** Wizard-of-Wikipedia, OpenDialKG.<br><br> [![Paper](https://img.shields.io/badge/IEEE%20Access-Paper-00629B?style=flat-square&logo=ieee&logoColor=white)](YOUR_DIALFILL_PAPER_LINK) [![Code](https://img.shields.io/badge/GitHub-Code-181717?style=flat-square&logo=github&logoColor=white)](YOUR_DIALFILL_CODE_LINK) |
| <img src="figs/dialfilldm_training.png" width="500px" alt="DialFill-DM Architecture"> | **DialFill-DM: Diffusion Models for Controllable Dialogue**<br><br>• **Preprint / Under Review**<br>• Replaces the autoregressive generator with a **masked diffusion language model** for more controllable answer spans.<br>• Introduces a **length head** (to locate the answer region) and a **keyword head** (to control entity copying).<br>• Improves robustness to noisy retrieval.<br><br> [![Paper](https://img.shields.io/badge/ArXiv-Preprint-B31B1B?style=flat-square&logo=arxiv&logoColor=white)](YOUR_DIALFILL_DM_PAPER_LINK) [![Code](https://img.shields.io/badge/GitHub-Code-181717?style=flat-square&logo=github&logoColor=white)](YOUR_DIALFILL_DM_CODE_LINK) |
